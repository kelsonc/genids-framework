...
|---|---|---|---|
| GenIDS-NB15 | [`xgboost_binary.ipynb`](genids_unsw15/1.unsw_xgb_baseline_binary.ipynb) | [`isolation_forest_binary.ipynb`](genids_unsw15/2.unsw_iforest_baseline_binary.ipynb) | [`xgboost_multiclass.ipynb`](genids_unsw15/3.unsw_xgb_baseline_multiclass.ipynb) |
| GenIDS-CIC17 | [`xgboost_binary.ipynb`](genids_cic17/1.cic17_xgb_baseline_binary.ipynb) | [`isolation_forest_binary.ipynb`](genids_cic17/2.cic17_iforest_baseline_binary.ipynb) | [`xgboost_multiclass.ipynb`](genids_cic17/3.cic17_xgb_baseline_multiclass.ipynb) |
| GenIDS-CIC18 | [`xgboost_binary.ipynb`](genids_cic18/1.cic18_xgb_baseline_binary.ipynb) | [`isolation_forest_binary.ipynb`](genids_cic18/2.cic18_iforest_baseline_binary.ipynb) | [`xgboost_multiclass.ipynb`](genids_cic18/3.cic18_xgb_baseline_multiclass.ipynb) |
